...
export default function AddItem4() {
    ...
    const handleAddFoodItem = async () => {
        ...
        if (!stock) {
            Alert.alert('Error', 'Please fill stock field.');
            return;
        }
        if (!image) {
        ...
        try {
            const response = await axios.post('http://192.168.165.203:5000/admin/4/add-food', formData, {
                headers: {
